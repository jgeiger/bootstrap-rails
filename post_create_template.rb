# Since rails 4 is in flux and really is a pain to setup
# this file will be run after the main application has already
# been setup. This just copies over the code
